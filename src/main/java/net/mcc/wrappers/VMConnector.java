...
public class VMConnector {
    ...
    public void startTask(String server, Long taskID) throws IOException {
        ...
        HttpURLConnection httpURLConnection = createPOSTURL(server, taskID, body.toString());
...
//        StringBuffer response = readResponse(httpURLConnection);
    ...
    private HttpURLConnection createPOSTURL(String server, Long taskID, String postBody) throws IOException {
